 ...
 * Follows a Singleton design pattern, as there should be just one BackEndSystem during the entire lifetime of the
 * system, and allows to hold data needed in different areas to be held at one place accessible to all areas.
 * Before the Object is created the SystemState is NOT_STARTED, it moves to STARTED when it is created.
 */
public class BackEndSystem {
    ...
    /**
     * Will make a new BackEndSystem if one has not been created yet, or else return the one that was previously
     * created.
     *
     * @return a BackEndSystem that was just created or was previously created.
     */
    ...
    /**
     * Initialises the StanfordCoreNLP and sets the SystemState to STARTED.
     */
    ...
    /**
     * Get the current state of the System according to the SystemState enum.
     *
    ...
    /**
     * Update the current state of the System, i.e. when the we are beginning to process Files the SystemState should be
     * set to PROCESSING.
     *
